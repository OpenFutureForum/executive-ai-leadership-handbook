# Board Director AI leadership playbook

A decision guide for oversight, risk appetite, succession, and long-term value. This chapter is practical guidance, not legal, financial, security, or investment advice.

## The leadership question

The useful question is not whether AI matters. It is how leaders will make defensible choices about oversight, risk appetite, succession, and long-term value. Treat the answer as an operating commitment: name the decision owner, define the boundary of authority, record the evidence being used, and set the next review point. A strategy that cannot be translated into those elements is still a theme, not a management system.
...
- What decision about oversight, risk appetite, succession, and long-term value is currently waiting for an owner?
...
- [Open Future Forum source](https://openfutureforum.com/research/board-director-ai-governance-report)
- Watch: [How should boards govern AI](https://www.youtube.com/watch?v=6wLv9hV16ns)
...
Explore the [Board Director community](https://openfutureforum.com/public-board-members) when a confidential, role-aligned setting would improve the quality of questions and judgment. Participation is not a substitute for company policy, professional advice, or accountable executive action.
