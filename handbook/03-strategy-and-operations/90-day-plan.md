# Run the first 90 days of executive AI leadership

A decision guide for a sequenced reset of ownership, portfolio, controls, measurement, and learning. This chapter is practical guidance, not legal, financial, security, or investment advice.

## The leadership question

The useful question is not whether AI matters. It is how leaders will make defensible choices about a sequenced reset of ownership, portfolio, controls, measurement, and learning. Treat the answer as an operating commitment: name the decision owner, define the boundary of authority, record the evidence being used, and set the next review point. A strategy that cannot be translated into those elements is still a theme, not a management system.
...
- What decision about a sequenced reset of ownership, portfolio, controls, measurement, and learning is currently waiting for an owner?
...
- [Open Future Forum source](https://openfutureforum.com/research/executive-ai-leverage-report)
