# Communicate AI progress without hype

A decision guide for clear claims, disclosed uncertainty, decision context, and evidence appropriate to the audience. This chapter is practical guidance, not legal, financial, security, or investment advice.

## The leadership question

The useful question is not whether AI matters. It is how leaders will make defensible choices about clear claims, disclosed uncertainty, decision context, and evidence appropriate to the audience. Treat the answer as an operating commitment: name the decision owner, define the boundary of authority, record the evidence being used, and set the next review point. A strategy that cannot be translated into those elements is still a theme, not a management system.
...
- What decision about clear claims, disclosed uncertainty, decision context, and evidence appropriate to the audience is currently waiting for an owner?
...
- [Open Future Forum source](https://openfutureforum.com/research/definitions/optimism-gap)
- Watch: [Why Most Companies Still Can’t Prove AI ROI](https://www.youtube.com/watch?v=DT6Fi2UjvsY)
