# Build a data foundation for accountable AI

A decision guide for data rights, provenance, quality, minimization, retention, and feedback. This chapter is practical guidance, not legal, financial, security, or investment advice.

## The leadership question

The useful question is not whether AI matters. It is how leaders will make defensible choices about data rights, provenance, quality, minimization, retention, and feedback. Treat the answer as an operating commitment: name the decision owner, define the boundary of authority, record the evidence being used, and set the next review point. A strategy that cannot be translated into those elements is still a theme, not a management system.
...
- What decision about data rights, provenance, quality, minimization, retention, and feedback is currently waiting for an owner?
...
- Watch: [How do you stop AI agents from corrupting their own memory](https://www.youtube.com/watch?v=dpPYFnykjDU)
