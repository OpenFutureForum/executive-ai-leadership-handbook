# Control agent identity, credentials, and access

A decision guide for least privilege, short-lived credentials, separation of duties, and traceability. This chapter is practical guidance, not legal, financial, security, or investment advice.

## The leadership question

The useful question is not whether AI matters. It is how leaders will make defensible choices about least privilege, short-lived credentials, separation of duties, and traceability. Treat the answer as an operating commitment: name the decision owner, define the boundary of authority, record the evidence being used, and set the next review point. A strategy that cannot be translated into those elements is still a theme, not a management system.
...
- What decision about least privilege, short-lived credentials, separation of duties, and traceability is currently waiting for an owner?
...
- [Open Future Forum source](https://openfutureforum.com/research/answers/biggest-ai-security-problem)
- Watch: [How should companies manage credentials and tokens for AI agents](https://www.youtube.com/watch?v=3_ROOBoqjbY)
