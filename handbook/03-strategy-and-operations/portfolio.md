# Build and govern the AI initiative portfolio

A decision guide for a visible portfolio with owners, hypotheses, dependencies, and stop rules. This chapter is practical guidance, not legal, financial, security, or investment advice.

## The leadership question

The useful question is not whether AI matters. It is how leaders will make defensible choices about a visible portfolio with owners, hypotheses, dependencies, and stop rules. Treat the answer as an operating commitment: name the decision owner, define the boundary of authority, record the evidence being used, and set the next review point. A strategy that cannot be translated into those elements is still a theme, not a management system.
...
- What decision about a visible portfolio with owners, hypotheses, dependencies, and stop rules is currently waiting for an owner?
...
- [Open Future Forum source](https://openfutureforum.com/research/answers/how-are-ai-budgets-funded)
- Watch: [How do CFOs decide which AI projects to fund - executive briefing](https://www.youtube.com/watch?v=tmobMrZFhm0)
