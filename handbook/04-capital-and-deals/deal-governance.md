# Assign executive ownership across the deal

A decision guide for capital and transaction decisions where ai changes the evidence, economics, or risk. This chapter is practical guidance, not legal, financial, security, or investment advice.

## The leadership question

The useful question is not whether AI matters. It is how leaders will make defensible choices about capital and transaction decisions where AI changes the evidence, economics, or risk. Treat the answer as an operating commitment: name the decision owner, define the boundary of authority, record the evidence being used, and set the next review point. A strategy that cannot be translated into those elements is still a theme, not a management system.
...
- What decision about capital and transaction decisions where AI changes the evidence, economics, or risk is currently waiting for an owner?
...
- [Open Future Forum source](https://openfutureforum.com/research/dealmakers/general-counsel)
- Watch: [Who Owns an M&A Deal: CEO, CFO, General Counsel or Corporate Development?](https://www.youtube.com/watch?v=SZbxRh0me7o)
