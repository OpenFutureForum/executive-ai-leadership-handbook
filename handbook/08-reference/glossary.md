...
A decision guide for a practical vocabulary for ownership, value, governance, agents, evidence, and peer learning. This chapter is practical guidance, not legal, financial, security, or investment advice.

## The leadership question

The useful question is not whether AI matters. It is how leaders will make defensible choices about a practical vocabulary for ownership, value, governance, agents, evidence, and peer learning. Treat the answer as an operating commitment: name the decision owner, define the boundary of authority, record the evidence being used, and set the next review point. A strategy that cannot be translated into those elements is still a theme, not a management system.
...
- What decision about a practical vocabulary for ownership, value, governance, agents, evidence, and peer learning is currently waiting for an owner?
