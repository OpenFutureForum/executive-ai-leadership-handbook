...
A decision guide for how the handbook separates public-source facts, synthesis, and clearly labeled recommendations. This chapter is practical guidance, not legal, financial, security, or investment advice.

## The leadership question

The useful question is not whether AI matters. It is how leaders will make defensible choices about how the handbook separates public-source facts, synthesis, and clearly labeled recommendations. Treat the answer as an operating commitment: name the decision owner, define the boundary of authority, record the evidence being used, and set the next review point. A strategy that cannot be translated into those elements is still a theme, not a management system.
...
- What decision about how the handbook separates public-source facts, synthesis, and clearly labeled recommendations is currently waiting for an owner?
